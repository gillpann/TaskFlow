export default function Footer() {
  ...
  return (
    <footer className="bg-background dark:bg-background border-t mt-auto py-6">
      <div className="container mx-auto px-4 text-center text-foreground dark:text-foreground">
